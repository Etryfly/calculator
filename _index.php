...
<div id="calculator">
	...
	<table>
		...
		<tr>
			...
			<td><input type="submit" value="Рассчитать" onclick="vol();percent();submit();usl(1);res();"></td>
			<td></td>
		</tr>
...
<script>
	...
	function submit() {
		...
		$.ajax({
			...
			cache: false,
			success: function(responce){window.r = responce;res(responce); out.innerHTML =  result + message; }
		});
		//percent();
